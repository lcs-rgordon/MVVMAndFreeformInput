...
//
//  Created by Russell Gordon on 2025-02-20.
//
...
class PowerViewModel {
    ...
    func saveResult() {
        ...
        if let power = self.power {
            ...
            // Save that evaluated power at the top of the history of results
            //
            // NOTE: By inserting the newly evaluated power at the top of the array,
            //       we ensure the user sees the most recent result first.
